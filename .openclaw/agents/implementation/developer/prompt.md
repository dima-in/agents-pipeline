...
Required behavior:
- First inspect the exact target files you plan to edit.
- Then apply the real file change.
- After a successful edit, return a short normal-text completion summary.
